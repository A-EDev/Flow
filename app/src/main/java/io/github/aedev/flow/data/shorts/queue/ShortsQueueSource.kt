...
sealed interface ShortsQueueSource {
    ...
    data object Saved : ShortsQueueSource {
        override fun encode(): String = SAVED
    }
...
val ShortsQueueSource.openAtVideoId: String?
    get() = when (this) {
        ...
        ShortsQueueSource.Feed, ShortsQueueSource.Saved -> null
    }
...
val ShortsQueueSource.continuesIntoFeed: Boolean
    get() = when (this) {
        ...
        ShortsQueueSource.Feed, ShortsQueueSource.Saved, is ShortsQueueSource.SeededFeed -> false
    }
