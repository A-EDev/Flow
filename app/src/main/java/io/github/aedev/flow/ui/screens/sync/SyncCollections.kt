...
internal val COLLECTION_KEYS = listOf(
...
@Composable
internal fun collectionLabel(key: String): String = when (key) {
...
@Composable
internal fun collectionDescription(key: String): String? = when (key) {
    ...
    SyncCollection.SUBSCRIPTIONS -> stringResource(R.string.sync_collection_subscriptions_body)
...
internal fun collectionIcon(key: String): ImageVector = when (key) {
    ...
    SyncCollection.SUBSCRIPTIONS -> Icons.Outlined.Subscriptions
