...
enum class PlaylistSortOrder(
    ...
    companion object {
        ...
        fun availableFor(isLocalPlaylist: Boolean): List<PlaylistSortOrder> =
            if (isLocalPlaylist) entries else entries.filterNot { it == DATE_ADDED_NEWEST || it == DATE_ADDED_OLDEST }
    }
}
